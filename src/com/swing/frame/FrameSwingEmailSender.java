...
import com.esprit.mail.JFilePicker;
import com.esprit.mail.SettingsDialog;



public class FrameSwingEmailSender extends JFrame {
	...
	public FrameSwingEmailSender(JMenuBar menuBar) {
		...
		menuItemSetting.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent event) {
				SettingsDialog dialog = new SettingsDialog(FrameSwingEmailSender.this, configUtil);
